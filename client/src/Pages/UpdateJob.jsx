...
import CreatableSelect from 'react-select/creatable';import { useLoaderData, useParams } from 'react-router-dom'

const UpdateJob = () => {

    const {id} = useParams();
    // console.log(id)
    const {_id, jobTitle, companyName, minPrice, maxPrice, salaryType, jobLocation, postingDate, experienceLevel, companyLogo, employmentType,
    ...
    <div className='amx-w-screen-2xl container mx-auto xl:px-24 px-4'>
       ...
       {/*first row*/}
        ...
        <div className='create-job-flex'>
            ...
            <input type="text" defaultValue={maxPrice} placeholder='$100k' {...register("maxPrice")} className='create-job-input' />
            </div>
        </div>
        ...
        <div className='create-job-flex'>
            ...
            <input type="text" defaultValue={jobLocation} placeholder='Ex: Colombo' {...register("jobLocation")} className='create-job-input' />
            </div>
        </div>
        ...
        <div className='create-job-flex'>
            ...
            <input type="date" defaultValue={postingDate} placeholder='Ex: 2023-12-29' {...register("postingDate")} className='create-job-input' />
            </div>
        ...
        <div className='create-job-flex'>
            ...
            <input type="url" defaultValue={companyLogo} placeholder='Paste your company logo URL: http://wetransfer.com/img1' {...register("companyLogo")} className='create-job-input' />
            </div>
